...
In cell #2, I calculated summary statistics of the data set using the Python ``len``function and ``np.unique``on ``y_train``to determine the number of classes. Here is the output from the code: 
